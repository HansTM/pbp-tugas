...
from todolist.views import show_todolist, register, login_user, logout_user, create_task, show_todolist_json, show_todolist_ajax, api_done, api_undone, api_delete, api_add
...
urlpatterns = [
	...
	# API (api/ prefix)
	path('api/add', api_add, name="api_add_2"),
